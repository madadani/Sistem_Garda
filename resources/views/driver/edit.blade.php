...
<div class="max-w-3xl mx-auto">
    <div class="bg-white rounded-xl shadow-md overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-primary-600 to-purple-600 px-6 py-4">
            <h3 class="text-xl font-semibold text-white">Form Edit Driver</h3>
        </div>

        <!-- Form -->
        <form action="{{ route('driver.update', $driver) }}" method="POST" class="p-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input 
                    ...
                    id="instansi" 
                    name="instansi" 
                    value="{{ old('instansi', $driver->instansi) }}"
